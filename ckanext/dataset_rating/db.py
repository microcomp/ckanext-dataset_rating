...
def init_db(model):
    class _DatasetRating(model.DomainObject):
    ...
    global DatasetRating
    DatasetRating = _DatasetRating
    ...
    types = sa.types
    global dataset_rating_table
    dataset_rating_table = sa.Table('dataset_rating', model.meta.metadata,
        ...
        sa.Column('rating', types.UnicodeText, default=u'')
    )
